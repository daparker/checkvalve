...
public class SourceSocket extends QuerySocket {
    ...
    protected static final String TAG = SourceSocket.class.getSimpleName();
    ...
    public SteamPacket getReply()
        ...
        if(this.packetIsSplit()) {
            ...
            do {
                ...
                Log.i(TAG, "Received packet #" + packetNumber + " of " + packetCount + " for request ID " + requestId + ".");
        ...
        if(isCompressed) {
            Log.i(TAG, "Received compressed reply of type \"" + packet.getClass().getSimpleName() + "\"");
        } else {
            Log.i(TAG, "Received reply of type \"" + packet.getClass().getSimpleName() + "\"");
        }
