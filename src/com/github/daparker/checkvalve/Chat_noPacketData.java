 ...
 */
public class Chat_noPacketData implements Runnable {
     ...
     */
    public Chat_noPacketData( String crIP, String crPort, String crPassword, String gsIP, String gsPort, Handler h )
            throws UnknownHostException {
