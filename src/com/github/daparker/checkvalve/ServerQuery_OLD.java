...
public class ServerQuery_OLD implements Runnable {
    ...
    private static final String TAG = ServerQuery_OLD.class.getSimpleName();
     ...
     */
    public ServerQuery_OLD( Context c, Handler h ) {
        this.context = c;
        this.status = 0;
        this.handler = h;
    }
