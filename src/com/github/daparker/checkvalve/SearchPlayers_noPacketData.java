...
public class SearchPlayers_noPacketData extends Thread {
    private static final String TAG = SearchPlayers_noPacketData.class.getSimpleName();
    ...
    public SearchPlayers_noPacketData( Context c, TableRow[] t, TableRow[] m, Handler h, String s ) {
        this.context = c;
        this.tableRows = t;
        this.messageRows = m;
        this.handler = h;
