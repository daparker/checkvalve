...
public class SettingsActivity_OLD extends Activity {
    private static final String TAG = SettingsActivity_OLD.class.getSimpleName();
    ...
    private EditText field_default_rcon_font_size;
    ...
    private OnTouchListener resetTouchListener = new OnTouchListener() {
        public boolean onTouch( View v, MotionEvent m ) {
            if( m.getAction() == MotionEvent.ACTION_DOWN ) {
                ...
                File filesDir = SettingsActivity_OLD.this.getFilesDir();
                ...
                UserVisibleMessage.showMessage(SettingsActivity_OLD.this, R.string.msg_options_reset);
            }
    ...
    private OnTouchListener clearSavedRelaysTouchListener = new OnTouchListener() {
        public boolean onTouch( View v, MotionEvent m ) {
            if( m.getAction() == MotionEvent.ACTION_DOWN ) {
                ...
                UserVisibleMessage.showMessage(SettingsActivity_OLD.this, R.string.msg_cleared_relay_list);
            }
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        if( database == null )
            database = new DatabaseProvider(SettingsActivity_OLD.this);
        ...
        field_default_rcon_font_size = (EditText)findViewById(R.id.field_default_rcon_font_size);
