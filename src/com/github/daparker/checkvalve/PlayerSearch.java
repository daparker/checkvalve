...
public class PlayerSearch extends Activity
{
    ...
    private OnClickListener searchButtonListener = new OnClickListener()
    {
        public void onClick( View v )
        {
            ...
            {
                UserVisibleMessage.showMessage(PlayerSearch.this, R.string.msg_empty_fields);
            }
            else
            {
    ...
    public void searchPlayers( String s )
    {
        ...
        searchPlayersIntent.setClassName("com.github.daparker.checkvalve", "com.github.daparker.checkvalve.SearchPlayersUI");
