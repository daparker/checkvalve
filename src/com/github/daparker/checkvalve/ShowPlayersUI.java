...
public class ShowPlayersUI extends Activity
{
    private static final String TAG = ShowPlayersUI.class.getSimpleName();
    ...
    public void onCreate( Bundle savedInstanceState )
    {
        ...
        this.setContentView(R.layout.queryplayers);
        ...
        if( database == null )
            database = new DatabaseProvider(ShowPlayersUI.this);
        
        playerList = getIntent().getParcelableArrayListExtra(Values.EXTRA_PLAYER_LIST);
        
        Log.d(TAG, "onCreate(): playerList=" + playerList.toString() + "; size=" + playerList.size());
    ...
    private void showPlayers()
    {
        for( int i = 0; i < playerList.size(); i++ )
        {
            ...
            TableRow row = new TableRow(ShowPlayersUI.this);
            
            TextView playerName = new TextView(ShowPlayersUI.this);
            TextView numKills = new TextView(ShowPlayersUI.this);
            TextView connected = new TextView(ShowPlayersUI.this);
